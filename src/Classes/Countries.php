...
/**
 * This is script handles countries: country codes, names and short names
...
final class Countries {
    ...
    private static $allowedCountries = ["KE","ZA","IN"];
    ...
    public static function getAllowedCountries() {
        ...
        foreach(self::$allowedCountries as $c) {
            $list[$c] = self::$countries[$c];
        }
